...
#
class zabbix::agent (
  $zabbix_type            = $zabbix::params::zabbix_type,
...
#  $allow_root            = $zabbix::params::allow_root,
  ...
  $agent_bin_dir          = $zabbix::params::agent_bin_dir,
  $source_bin             = $zabbix::params::agent_source_bin_include,
  $source_conf            = $zabbix::params::agent_source_conf_include,
