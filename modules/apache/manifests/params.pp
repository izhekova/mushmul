...
#  $source = 'puppet:///modules/apache/httpd.conf'
  $source = ''
  $source_jk = 'puppet:///modules/apache/jk_config'
  $source_worker = 'puppet:///modules/apache/worker.properties'
  $source_dir = ""
...
#  $config_file_jk            = '/etc/httpd/conf.d/jk_config'
#  $config_file_worker        = '/etc/httpd/conf/worker.properties'
  $config_file_jk            = false
  $config_file_worker        = false
  $modules_dir               = '/etc/httpd/modules'
  $modules_dir_source        = '/usr/lib64/httpd/modules'
  $include_jk                = 'No'
  $jk_module                 = 'puppet:///modules/apache/mod_jk.so'
  $path_mod_jk               = '/etc/httpd/modules/mod_jk.so'
  $ssl_cert                  =  false
  $ssl_key                   =  false
#  $ssl_dir                   = '/etc/httpd/conf/ssl'
#  $ssl_conf_file             = '/etc/httpd/conf.d/ssl.conf'
  $ssl_conf_file_source      = 'puppet:///modules/apache/ssl.conf'
#  $source_ssl_dir            = 'puppet:///modules/apache/ssl'
  $source_ssl_dir            = false
  $rewrite_rules             = false
#  $rewrite_rules_dir         = '/etc/httpd/conf.d/rewrite'
  $rewrite_rules_dir         = false
  $rewrite_rules_source      = 'puppet:///modules/apache/rewrite'
}
